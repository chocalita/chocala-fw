...
class HttpUpgradeRequiredExceptionTest extends TestCase
{
    ...
    {
        $this->defaultStatusCode = StatusCode::UPGRADE_REQUIRED();
    }

    public function test__construct()
    {
        $e = new HttpUpgradeRequiredException();
        $this->assertBasics($e);

        $e = new HttpUpgradeRequiredException('My message');
        $this->assertBasics($e);

        $e = new HttpUpgradeRequiredException('My message', new \Exception('Test exception'));
        $this->assertBasics($e);
    }
    ...
    public function testStatusCodeProperties()
    {
        ...
        $e = new HttpUpgradeRequiredException($myMessage);
        $this->assertBasics($e);
        $this->assertBasicsStatusCode($e);
        self::assertEquals($this->defaultStatusCode->code(), $e->statusCode()->code());
    ...
    private function assertBasics($e)
    {
        ...
        self::assertInstanceOf(HttpUpgradeRequiredException::class, $e);
    }
