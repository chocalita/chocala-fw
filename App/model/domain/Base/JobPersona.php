...
/**
 * Base class that represents a row from the 'job_persona' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class JobPersona implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\JobPersonaTableMap';
    ...
    /**
     * Initializes internal state of Base\JobPersona object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>JobPersona</code> instance.  If
     * <code>obj</code> is an instance of <code>JobPersona</code>, delegates to
     * <code>equals(JobPersona)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|JobPersona The current object, for fluid interface
     */
     ...
     * @return $this|\JobPersona The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_USER_ID] = true;
        }
    ...
    public function setLocationId($v)
    {
        ...
        if ($this->location_id !== $v) {
            $this->location_id = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_LOCATION_ID] = true;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_FIRST_NAME] = true;
        }
    ...
    public function setMiddleName($v)
    {
        ...
        if ($this->middle_name !== $v) {
            $this->middle_name = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_MIDDLE_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function setSecondLastName($v)
    {
        ...
        if ($this->second_last_name !== $v) {
            ...
            $this->modifiedColumns[JobPersonaTableMap::COL_SECOND_LAST_NAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_EMAIL] = true;
        }
    ...
    public function setIdNumber($v)
    {
        ...
        if ($this->id_number !== $v) {
            $this->id_number = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_ID_NUMBER] = true;
        }
    ...
    public function setIdExtension($v)
    {
        ...
        if ($this->id_extension !== $v) {
            $this->id_extension = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_ID_EXTENSION] = true;
        }
    ...
    public function setGender($v)
    {
        ...
        if ($this->gender !== $v) {
            $this->gender = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_GENDER] = true;
        }
    ...
    public function setDateOfBirth($v)
    {
        ...
        if ($this->date_of_birth !== null || $dt !== null) {
            if ($this->date_of_birth === null || $dt === null || $dt->format("Y-m-d") !== $this->date_of_birth->format("Y-m-d")) {
                ...
                $this->modifiedColumns[JobPersonaTableMap::COL_DATE_OF_BIRTH] = true;
            }
    ...
    public function setPlaceOfBirth($v)
    {
        ...
        if ($this->place_of_birth !== $v) {
            ...
            $this->modifiedColumns[JobPersonaTableMap::COL_PLACE_OF_BIRTH] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_CITY] = true;
        }
    ...
    public function setPob($v)
    {
        ...
        if ($this->pob !== $v) {
            $this->pob = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_POB] = true;
        }
    ...
    public function setPhoneHome($v)
    {
        ...
        if ($this->phone_home !== $v) {
            $this->phone_home = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_PHONE_HOME] = true;
        }
    ...
    public function setPhoneWork($v)
    {
        ...
        if ($this->phone_work !== $v) {
            $this->phone_work = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_PHONE_WORK] = true;
        }
    ...
    public function setCellphone1($v)
    {
        ...
        if ($this->cellphone_1 !== $v) {
            $this->cellphone_1 = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_CELLPHONE_1] = true;
        }
    ...
    public function setCellphone2($v)
    {
        ...
        if ($this->cellphone_2 !== $v) {
            $this->cellphone_2 = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_CELLPHONE_2] = true;
        }
    ...
    public function setPhotoMime($v)
    {
        ...
        if ($this->photo_mime !== $v) {
            $this->photo_mime = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_PHOTO_MIME] = true;
        }
    ...
    public function setLastUserId($v)
    {
        ...
        if ($this->last_user_id !== $v) {
            $this->last_user_id = $v;
            $this->modifiedColumns[JobPersonaTableMap::COL_LAST_USER_ID] = true;
        }
    ...
    public function setCreationDate($v)
    {
        ...
        if ($this->creation_date !== null || $dt !== null) {
            if ($this->creation_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->creation_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[JobPersonaTableMap::COL_CREATION_DATE] = true;
            }
        } // if either are not null
    ...
    public function setModificationDate($v)
    {
        ...
        if ($this->modification_date !== null || $dt !== null) {
            if ( ($dt != $this->modification_date) // normalized values don't match
                ...
                $this->modifiedColumns[JobPersonaTableMap::COL_MODIFICATION_DATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : JobPersonaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : JobPersonaTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : JobPersonaTableMap::translateFieldName('LocationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->location_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : JobPersonaTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : JobPersonaTableMap::translateFieldName('MiddleName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->middle_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : JobPersonaTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : JobPersonaTableMap::translateFieldName('SecondLastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->second_last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : JobPersonaTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : JobPersonaTableMap::translateFieldName('IdNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : JobPersonaTableMap::translateFieldName('IdExtension', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_extension = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : JobPersonaTableMap::translateFieldName('Gender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gender = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : JobPersonaTableMap::translateFieldName('DateOfBirth', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_of_birth = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : JobPersonaTableMap::translateFieldName('PlaceOfBirth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->place_of_birth = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : JobPersonaTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : JobPersonaTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : JobPersonaTableMap::translateFieldName('Pob', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pob = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : JobPersonaTableMap::translateFieldName('PhoneHome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_home = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : JobPersonaTableMap::translateFieldName('PhoneWork', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_work = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : JobPersonaTableMap::translateFieldName('Cellphone1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cellphone_1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : JobPersonaTableMap::translateFieldName('Cellphone2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cellphone_2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : JobPersonaTableMap::translateFieldName('PhotoMime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->photo_mime = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : JobPersonaTableMap::translateFieldName('LastUserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : JobPersonaTableMap::translateFieldName('CreationDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->creation_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : JobPersonaTableMap::translateFieldName('ModificationDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 24; // 24 = JobPersonaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\JobPersona'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildJobPersonaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see JobPersona::setDeleted()
     * @see JobPersona::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildJobPersonaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JobPersonaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(JobPersonaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_LOCATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'LOCATION_ID';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'FIRST_NAME';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_MIDDLE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'MIDDLE_NAME';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'LAST_NAME';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_SECOND_LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'SECOND_LAST_NAME';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'EMAIL';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_ID_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'ID_NUMBER';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_ID_EXTENSION)) {
            $modifiedColumns[':p' . $index++]  = 'ID_EXTENSION';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_GENDER)) {
            $modifiedColumns[':p' . $index++]  = 'GENDER';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_DATE_OF_BIRTH)) {
            $modifiedColumns[':p' . $index++]  = 'DATE_OF_BIRTH';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PLACE_OF_BIRTH)) {
            $modifiedColumns[':p' . $index++]  = 'PLACE_OF_BIRTH';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'ADDRESS';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'CITY';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_POB)) {
            $modifiedColumns[':p' . $index++]  = 'POB';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PHONE_HOME)) {
            $modifiedColumns[':p' . $index++]  = 'PHONE_HOME';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PHONE_WORK)) {
            $modifiedColumns[':p' . $index++]  = 'PHONE_WORK';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CELLPHONE_1)) {
            $modifiedColumns[':p' . $index++]  = 'CELLPHONE_1';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CELLPHONE_2)) {
            $modifiedColumns[':p' . $index++]  = 'CELLPHONE_2';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PHOTO_MIME)) {
            $modifiedColumns[':p' . $index++]  = 'PHOTO_MIME';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_LAST_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'LAST_USER_ID';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CREATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'CREATION_DATE';
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_MODIFICATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'MODIFICATION_DATE';
        }

        $sql = sprintf(
            'INSERT INTO job_persona (%s) VALUES (%s)',
    ...
    {
        $pos = JobPersonaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['JobPersona'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JobPersona'][$this->hashCode()] = true;
        $keys = JobPersonaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JobPersonaTableMap::COL_ID)) {
            $criteria->add(JobPersonaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_USER_ID)) {
            $criteria->add(JobPersonaTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_LOCATION_ID)) {
            $criteria->add(JobPersonaTableMap::COL_LOCATION_ID, $this->location_id);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_FIRST_NAME)) {
            $criteria->add(JobPersonaTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_MIDDLE_NAME)) {
            $criteria->add(JobPersonaTableMap::COL_MIDDLE_NAME, $this->middle_name);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_LAST_NAME)) {
            $criteria->add(JobPersonaTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_SECOND_LAST_NAME)) {
            $criteria->add(JobPersonaTableMap::COL_SECOND_LAST_NAME, $this->second_last_name);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_EMAIL)) {
            $criteria->add(JobPersonaTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_ID_NUMBER)) {
            $criteria->add(JobPersonaTableMap::COL_ID_NUMBER, $this->id_number);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_ID_EXTENSION)) {
            $criteria->add(JobPersonaTableMap::COL_ID_EXTENSION, $this->id_extension);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_GENDER)) {
            $criteria->add(JobPersonaTableMap::COL_GENDER, $this->gender);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_DATE_OF_BIRTH)) {
            $criteria->add(JobPersonaTableMap::COL_DATE_OF_BIRTH, $this->date_of_birth);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PLACE_OF_BIRTH)) {
            $criteria->add(JobPersonaTableMap::COL_PLACE_OF_BIRTH, $this->place_of_birth);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_ADDRESS)) {
            $criteria->add(JobPersonaTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CITY)) {
            $criteria->add(JobPersonaTableMap::COL_CITY, $this->city);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_POB)) {
            $criteria->add(JobPersonaTableMap::COL_POB, $this->pob);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PHONE_HOME)) {
            $criteria->add(JobPersonaTableMap::COL_PHONE_HOME, $this->phone_home);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PHONE_WORK)) {
            $criteria->add(JobPersonaTableMap::COL_PHONE_WORK, $this->phone_work);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CELLPHONE_1)) {
            $criteria->add(JobPersonaTableMap::COL_CELLPHONE_1, $this->cellphone_1);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CELLPHONE_2)) {
            $criteria->add(JobPersonaTableMap::COL_CELLPHONE_2, $this->cellphone_2);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_PHOTO_MIME)) {
            $criteria->add(JobPersonaTableMap::COL_PHOTO_MIME, $this->photo_mime);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_LAST_USER_ID)) {
            $criteria->add(JobPersonaTableMap::COL_LAST_USER_ID, $this->last_user_id);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_CREATION_DATE)) {
            $criteria->add(JobPersonaTableMap::COL_CREATION_DATE, $this->creation_date);
        }
        if ($this->isColumnModified(JobPersonaTableMap::COL_MODIFICATION_DATE)) {
            $criteria->add(JobPersonaTableMap::COL_MODIFICATION_DATE, $this->modification_date);
        }
    ...
    {
        $criteria = ChildJobPersonaQuery::create();
        $criteria->add(JobPersonaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \JobPersona (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \JobPersona Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSysUser(ConnectionInterface $con = null)
    {
        if ($this->aSysUser === null && ($this->user_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSysUser->addJobPersonas($this);
             */
        }
    ...
    {
        if (null !== $this->aSysUser) {
            $this->aSysUser->removeJobPersona($this);
        }
        $this->id = null;
        $this->user_id = null;
    ...
    {
        return (string) $this->exportTo(JobPersonaTableMap::DEFAULT_STRING_FORMAT);
    }
