 ...
 *
 * @method     \App\model\domain\SysEventQuery|\App\model\domain\SysUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SysEventUserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\model\domain\Base\SysEventUserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\model\\domain\\SysEventUser', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\model\domain\SysEvent object
     *
     * @param \App\model\domain\SysEvent|ObjectCollection $sysEvent The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($sysEvent instanceof \App\model\domain\SysEvent) {
            return $this
            ...
            throw new PropelException('filterBySysEvent() only accepts arguments of type \App\model\domain\SysEvent or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\model\domain\SysEventQuery A secondary query class using the current class as primary query
     */
    public function useSysEventQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSysEvent($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SysEvent', '\App\model\domain\SysEventQuery');
    }
