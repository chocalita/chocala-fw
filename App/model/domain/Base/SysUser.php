...
use \Exception;
use \PDO;
use App\model\domain\SysAuth as ChildSysAuth;
use App\model\domain\SysAuthQuery as ChildSysAuthQuery;
use App\model\domain\SysEmailSent as ChildSysEmailSent;
use App\model\domain\SysEmailSentQuery as ChildSysEmailSentQuery;
use App\model\domain\SysEntityUser as ChildSysEntityUser;
...
use App\model\domain\SysImage as ChildSysImage;
...
use App\model\domain\Map\SysPersonTableMap;
...
abstract class SysUser implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\model\\domain\\Map\\SysUserTableMap';
    ...
    /**
     * Initializes internal state of App\model\domain\Base\SysUser object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\App\model\domain\SysUser The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\model\\domain\\SysUser'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->sysAuthsScheduledForDeletion !== null) {
                if (!$this->sysAuthsScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysAuthQuery::create()
            ...
            if ($this->sysEntityUsersScheduledForDeletion !== null) {
                if (!$this->sysEntityUsersScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysEntityUserQuery::create()
            ...
            if ($this->sysImagesScheduledForDeletion !== null) {
                if (!$this->sysImagesScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysImageQuery::create()
            ...
            if ($this->sysPasswordsScheduledForDeletion !== null) {
                if (!$this->sysPasswordsScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysPasswordQuery::create()
            ...
            if ($this->sysPasswordRequestsScheduledForDeletion !== null) {
                if (!$this->sysPasswordRequestsScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysPasswordRequestQuery::create()
            ...
            if ($this->syspeopleScheduledForDeletion !== null) {
                if (!$this->syspeopleScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysPersonQuery::create()
            ...
            if ($this->sysUserParamsScheduledForDeletion !== null) {
                if (!$this->sysUserParamsScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysUserParamQuery::create()
            ...
            if ($this->sysUserXRolsScheduledForDeletion !== null) {
                if (!$this->sysUserXRolsScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysUserXRolQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\model\domain\SysUser
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\model\domain\SysUser The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\model\domain\SysUser (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\model\domain\SysUser Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSysAuths($overrideExisting = true)
    {
        ...
        $this->collSysAuths->setModel('\App\model\domain\SysAuth');
    }
    ...
    public function initSysEmailSents($overrideExisting = true)
    {
        ...
        $this->collSysEmailSents->setModel('\App\model\domain\SysEmailSent');
    }
    ...
    public function initSysEntityUsers($overrideExisting = true)
    {
        ...
        $this->collSysEntityUsers->setModel('\App\model\domain\SysEntityUser');
    }
    ...
    public function initSysImages($overrideExisting = true)
    {
        ...
        $this->collSysImages->setModel('\App\model\domain\SysImage');
    }
    ...
    public function initSysPasswords($overrideExisting = true)
    {
        ...
        $this->collSysPasswords->setModel('\App\model\domain\SysPassword');
    }
    ...
    public function initSysPasswordRequests($overrideExisting = true)
    {
        ...
        $this->collSysPasswordRequests->setModel('\App\model\domain\SysPasswordRequest');
    }
    ...
    public function initSyspeople($overrideExisting = true)
    {
        ...
        $this->collSyspeople->setModel('\App\model\domain\SysPerson');
    }
    ...
    public function initSysUserParams($overrideExisting = true)
    {
        ...
        $this->collSysUserParams->setModel('\App\model\domain\SysUserParam');
    }
    ...
    public function initSysUserXRols($overrideExisting = true)
    {
        ...
        $this->collSysUserXRols->setModel('\App\model\domain\SysUserXRol');
    }
