 ...
 *
 * @method     \App\model\domain\SysEntityQuery|\App\model\domain\SysRolQuery|\App\model\domain\SysUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SysEntityUserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\model\domain\Base\SysEntityUserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\model\\domain\\SysEntityUser', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\model\domain\SysRol object
     *
     * @param \App\model\domain\SysRol|ObjectCollection $sysRol The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($sysRol instanceof \App\model\domain\SysRol) {
            return $this
            ...
            throw new PropelException('filterBySysRol() only accepts arguments of type \App\model\domain\SysRol or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\model\domain\SysRolQuery A secondary query class using the current class as primary query
     */
    public function useSysRolQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSysRol($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SysRol', '\App\model\domain\SysRolQuery');
    }
