...
abstract class SysEntity implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\model\\domain\\Map\\SysEntityTableMap';
    ...
    /**
     * Initializes internal state of App\model\domain\Base\SysEntity object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\App\model\domain\SysEntity The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\model\\domain\\SysEntity'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->sysEntityBranchesScheduledForDeletion !== null) {
                if (!$this->sysEntityBranchesScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysEntityBranchQuery::create()
            ...
            if ($this->sysEntityParamsScheduledForDeletion !== null) {
                if (!$this->sysEntityParamsScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysEntityParamQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\model\domain\SysEntity
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\model\domain\SysEntity The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\model\domain\SysEntity (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\model\domain\SysEntity Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSysEntityBranches($overrideExisting = true)
    {
        ...
        $this->collSysEntityBranches->setModel('\App\model\domain\SysEntityBranch');
    }
    ...
    public function initSysEntityParams($overrideExisting = true)
    {
        ...
        $this->collSysEntityParams->setModel('\App\model\domain\SysEntityParam');
    }
