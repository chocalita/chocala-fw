...
abstract class SysUri implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\SysUriTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildSysRolXUri> Collection to store aggregation of ChildSysRolXUri objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildSysRolXUri>
     */
    ...
    /**
     * Initializes internal state of Base\SysUri object.
     * @see applyDefaults()
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SysUri'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \SysUri (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SysUri Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return void
     */
    public function resetPartialSysRolXUris($v = true): void
    {
     ...
     * @return void
     */
    public function initSysRolXUris(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSysRolXUri> List of ChildSysRolXUri objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collSysRolXUris || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collSysRolXUris) {
                    ...
                    $collSysRolXUris = new $collectionClassName;
                    $collSysRolXUris->setModel('\SysRolXUri');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSysRolXUris(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSysRolXUrisPartial && !$this->isNew();
        if (null === $this->collSysRolXUris || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSysRolXUri(ChildSysRolXUri $sysRolXUri): void
    {
