 ...
 *
 * @method     \App\model\domain\SysEntityTypeQuery|\App\model\domain\SysLocationQuery|\App\model\domain\SysEntityBranchQuery|\App\model\domain\SysEntityParamQuery|\App\model\domain\SysEntityUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SysEntityQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\model\domain\Base\SysEntityQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\model\\domain\\SysEntity', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\model\domain\SysEntityType object
     *
     * @param \App\model\domain\SysEntityType|ObjectCollection $sysEntityType The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($sysEntityType instanceof \App\model\domain\SysEntityType) {
            return $this
            ...
            throw new PropelException('filterBySysEntityType() only accepts arguments of type \App\model\domain\SysEntityType or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\model\domain\SysEntityTypeQuery A secondary query class using the current class as primary query
     */
    public function useSysEntityTypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SysEntityType', '\App\model\domain\SysEntityTypeQuery');
    }
    ...
    /**
     * Filter the query by a related \App\model\domain\SysEntityBranch object
     *
     * @param \App\model\domain\SysEntityBranch|ObjectCollection $sysEntityBranch the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSysEntityQuery The current query, for fluid interface
     */
    ...
    {
        if ($sysEntityBranch instanceof \App\model\domain\SysEntityBranch) {
            return $this
            ...
            throw new PropelException('filterBySysEntityBranch() only accepts arguments of type \App\model\domain\SysEntityBranch or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\model\domain\SysEntityBranchQuery A secondary query class using the current class as primary query
     */
    public function useSysEntityBranchQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SysEntityBranch', '\App\model\domain\SysEntityBranchQuery');
    }
