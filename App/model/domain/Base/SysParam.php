...
abstract class SysParam implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\model\\domain\\Map\\SysParamTableMap';
    ...
    /**
     * Initializes internal state of App\model\domain\Base\SysParam object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|SysParam The current object, for fluid interface
     */
     ...
     * @return $this|\App\model\domain\SysParam The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\model\\domain\\SysParam'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\model\domain\SysParam
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\model\domain\SysParam The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\model\domain\SysParam (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\model\domain\SysParam Clone of current object.
     * @throws PropelException
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSysParam The current object (for fluent API support)
     */
