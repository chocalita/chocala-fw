...
/**
 * Base class that represents a row from the 'job_area' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class JobArea implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\JobAreaTableMap';
    ...
    /**
     * Initializes internal state of Base\JobArea object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>JobArea</code> instance.  If
     * <code>obj</code> is an instance of <code>JobArea</code>, delegates to
     * <code>equals(JobArea)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|JobArea The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[JobAreaTableMap::COL_ID] = true;
        }
    ...
    public function setCodigo($v)
    {
        ...
        if ($this->codigo !== $v) {
            $this->codigo = $v;
            $this->modifiedColumns[JobAreaTableMap::COL_CODIGO] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[JobAreaTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[JobAreaTableMap::COL_DESCRIPCION] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[JobAreaTableMap::COL_STATUS] = true;
        }
    ...
    public function setLastUserId($v)
    {
        ...
        if ($this->last_user_id !== $v) {
            $this->last_user_id = $v;
            $this->modifiedColumns[JobAreaTableMap::COL_LAST_USER_ID] = true;
        }
    ...
    public function setCreationDate($v)
    {
        ...
        if ($this->creation_date !== null || $dt !== null) {
            if ($this->creation_date === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->creation_date->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[JobAreaTableMap::COL_CREATION_DATE] = true;
            }
    ...
    public function setModificationDate($v)
    {
        ...
        if ($this->modification_date !== null || $dt !== null) {
            if ($this->modification_date === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->modification_date->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[JobAreaTableMap::COL_MODIFICATION_DATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : JobAreaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : JobAreaTableMap::translateFieldName('Codigo', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildJobAreaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see JobArea::setDeleted()
     * @see JobArea::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildJobAreaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JobAreaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[JobAreaTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . JobAreaTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(JobAreaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_CODIGO)) {
        ...
        if ($this->isColumnModified(JobAreaTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'STATUS';
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_LAST_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'LAST_USER_ID';
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_CREATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'CREATION_DATE';
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_MODIFICATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'MODIFICATION_DATE';
        }

        $sql = sprintf(
            'INSERT INTO job_area (%s) VALUES (%s)',
    ...
    {
        $pos = JobAreaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['JobArea'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JobArea'][$this->hashCode()] = true;
        $keys = JobAreaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(JobAreaTableMap::DATABASE_NAME);

        if ($this->isColumnModified(JobAreaTableMap::COL_ID)) {
            $criteria->add(JobAreaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_CODIGO)) {
            $criteria->add(JobAreaTableMap::COL_CODIGO, $this->codigo);
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_NOMBRE)) {
        ...
        if ($this->isColumnModified(JobAreaTableMap::COL_STATUS)) {
            $criteria->add(JobAreaTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_LAST_USER_ID)) {
            $criteria->add(JobAreaTableMap::COL_LAST_USER_ID, $this->last_user_id);
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_CREATION_DATE)) {
            $criteria->add(JobAreaTableMap::COL_CREATION_DATE, $this->creation_date);
        }
        if ($this->isColumnModified(JobAreaTableMap::COL_MODIFICATION_DATE)) {
            $criteria->add(JobAreaTableMap::COL_MODIFICATION_DATE, $this->modification_date);
        }
    ...
    {
        $criteria = ChildJobAreaQuery::create();
        $criteria->add(JobAreaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \JobArea (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \JobArea Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildJobArea is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildJobArea The current object (for fluent API support)
     */
    public function setJobAvisos(Collection $jobAvisos, ConnectionInterface $con = null)
    {
        ...
        foreach ($jobAvisosToDelete as $jobAvisoRemoved) {
            $jobAvisoRemoved->setJobArea(null);
        }
     ...
     * Otherwise if this JobArea is new, it will return
     * an empty collection; or if this JobArea has previously
     * been saved, it will retrieve related JobAvisos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JobArea.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildJobAviso[] List of ChildJobAviso objects
     */
    public function getJobAvisosJoinJobEmpresaSuscrita(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildJobAvisoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(JobAreaTableMap::DEFAULT_STRING_FORMAT);
    }
