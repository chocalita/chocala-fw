 ...
 *
 * @method     ChildSysLocation|null findOne(?ConnectionInterface $con = null) Return the first ChildSysLocation matching the query
 ...
 *
 * @method     ChildSysLocation|null findOneById(int $ID) Return the first ChildSysLocation filtered by the ID column
 * @method     ChildSysLocation|null findOneByMainId(int $MAIN_ID) Return the first ChildSysLocation filtered by the MAIN_ID column
 * @method     ChildSysLocation|null findOneByCode(string $CODE) Return the first ChildSysLocation filtered by the CODE column
 * @method     ChildSysLocation|null findOneByStatus(string $STATUS) Return the first ChildSysLocation filtered by the STATUS column
 * @method     ChildSysLocation|null findOneByName(string $NAME) Return the first ChildSysLocation filtered by the NAME column
 * @method     ChildSysLocation|null findOneByType(string $TYPE) Return the first ChildSysLocation filtered by the TYPE column
 * @method     ChildSysLocation|null findOneByLevel(int $LEVEL) Return the first ChildSysLocation filtered by the LEVEL column
 * @method     ChildSysLocation|null findOneByLft(int $LFT) Return the first ChildSysLocation filtered by the LFT column
 * @method     ChildSysLocation|null findOneByRgt(int $RGT) Return the first ChildSysLocation filtered by the RGT column
 * @method     ChildSysLocation|null findOneByLastUserId(int $LAST_USER_ID) Return the first ChildSysLocation filtered by the LAST_USER_ID column
 * @method     ChildSysLocation|null findOneByCreationDate(string $CREATION_DATE) Return the first ChildSysLocation filtered by the CREATION_DATE column
 * @method     ChildSysLocation|null findOneByModificationDate(string $MODIFICATION_DATE) Return the first ChildSysLocation filtered by the MODIFICATION_DATE column
 *
 ...
 *
 * @method     ChildSysLocation[]|Collection find(?ConnectionInterface $con = null) Return ChildSysLocation objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSysLocation> find(?ConnectionInterface $con = null) Return ChildSysLocation objects based on current ModelCriteria
 *
 * @method     ChildSysLocation[]|Collection findById(int|array<int> $ID) Return ChildSysLocation objects filtered by the ID column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findById(int|array<int> $ID) Return ChildSysLocation objects filtered by the ID column
 * @method     ChildSysLocation[]|Collection findByMainId(int|array<int> $MAIN_ID) Return ChildSysLocation objects filtered by the MAIN_ID column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByMainId(int|array<int> $MAIN_ID) Return ChildSysLocation objects filtered by the MAIN_ID column
 * @method     ChildSysLocation[]|Collection findByCode(string|array<string> $CODE) Return ChildSysLocation objects filtered by the CODE column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByCode(string|array<string> $CODE) Return ChildSysLocation objects filtered by the CODE column
 * @method     ChildSysLocation[]|Collection findByStatus(string|array<string> $STATUS) Return ChildSysLocation objects filtered by the STATUS column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByStatus(string|array<string> $STATUS) Return ChildSysLocation objects filtered by the STATUS column
 * @method     ChildSysLocation[]|Collection findByName(string|array<string> $NAME) Return ChildSysLocation objects filtered by the NAME column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByName(string|array<string> $NAME) Return ChildSysLocation objects filtered by the NAME column
 * @method     ChildSysLocation[]|Collection findByType(string|array<string> $TYPE) Return ChildSysLocation objects filtered by the TYPE column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByType(string|array<string> $TYPE) Return ChildSysLocation objects filtered by the TYPE column
 * @method     ChildSysLocation[]|Collection findByLevel(int|array<int> $LEVEL) Return ChildSysLocation objects filtered by the LEVEL column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByLevel(int|array<int> $LEVEL) Return ChildSysLocation objects filtered by the LEVEL column
 * @method     ChildSysLocation[]|Collection findByLft(int|array<int> $LFT) Return ChildSysLocation objects filtered by the LFT column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByLft(int|array<int> $LFT) Return ChildSysLocation objects filtered by the LFT column
 * @method     ChildSysLocation[]|Collection findByRgt(int|array<int> $RGT) Return ChildSysLocation objects filtered by the RGT column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByRgt(int|array<int> $RGT) Return ChildSysLocation objects filtered by the RGT column
 * @method     ChildSysLocation[]|Collection findByLastUserId(int|array<int> $LAST_USER_ID) Return ChildSysLocation objects filtered by the LAST_USER_ID column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByLastUserId(int|array<int> $LAST_USER_ID) Return ChildSysLocation objects filtered by the LAST_USER_ID column
 * @method     ChildSysLocation[]|Collection findByCreationDate(string|array<string> $CREATION_DATE) Return ChildSysLocation objects filtered by the CREATION_DATE column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByCreationDate(string|array<string> $CREATION_DATE) Return ChildSysLocation objects filtered by the CREATION_DATE column
 * @method     ChildSysLocation[]|Collection findByModificationDate(string|array<string> $MODIFICATION_DATE) Return ChildSysLocation objects filtered by the MODIFICATION_DATE column
 * @psalm-method Collection&\Traversable<ChildSysLocation> findByModificationDate(string|array<string> $MODIFICATION_DATE) Return ChildSysLocation objects filtered by the MODIFICATION_DATE column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSysLocation> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class SysLocationQuery extends ModelCriteria
{
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SysLocationTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_ID, $id, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByMainId($mainId = null, ?string $comparison = null)
    {
        if (is_array($mainId)) {
            $useMinMax = false;
            if (isset($mainId['min'])) {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_MAIN_ID, $mainId, $comparison);
    ...
    public function filterByCode($code = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_CODE, $code, $comparison);
    ...
    public function filterByStatus($status = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_STATUS, $status, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByType($type = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_TYPE, $type, $comparison);
    ...
    public function filterByLevel($level = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_LEVEL, $level, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByLft($lft = null, ?string $comparison = null)
    {
        if (is_array($lft)) {
            $useMinMax = false;
            if (isset($lft['min'])) {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_LFT, $lft, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByRgt($rgt = null, ?string $comparison = null)
    {
        if (is_array($rgt)) {
            $useMinMax = false;
            if (isset($rgt['min'])) {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_RGT, $rgt, $comparison);
    ...
    public function filterByLastUserId($lastUserId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_LAST_USER_ID, $lastUserId, $comparison);
    ...
    public function filterByCreationDate($creationDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_CREATION_DATE, $creationDate, $comparison);
    ...
    public function filterByModificationDate($modificationDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysLocationTableMap::COL_MODIFICATION_DATE, $modificationDate, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSysEntity(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
