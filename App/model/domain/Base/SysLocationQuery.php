...
use App\model\domain\Map\SysLocationTableMap;
 ...
 *
 * @method     \App\model\domain\SysEntityQuery|\App\model\domain\SysEntityBranchQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SysLocationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\model\domain\Base\SysLocationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\model\\domain\\SysLocation', $modelAlias = null)
    {
     ...
     *
     * @param \App\model\domain\SysEntity|ObjectCollection $sysEntity the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
