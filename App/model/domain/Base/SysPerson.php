...
abstract class SysPerson implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\model\\domain\\Map\\SysPersonTableMap';
    ...
    /**
     * Initializes internal state of App\model\domain\Base\SysPerson object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\App\model\domain\SysPerson The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\model\\domain\\SysPerson'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\model\domain\SysPerson
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\model\domain\SysPerson The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\model\domain\SysPerson (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\model\domain\SysPerson Clone of current object.
     * @throws PropelException
     */
