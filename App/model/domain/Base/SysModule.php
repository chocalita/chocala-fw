...
abstract class SysModule implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\model\\domain\\Map\\SysModuleTableMap';
    ...
    /**
     * Initializes internal state of App\model\domain\Base\SysModule object.
     */
     ...
     *
     * @return $this|SysModule The current object, for fluid interface
     */
     ...
     * @return $this|\App\model\domain\SysModule The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\model\\domain\\SysModule'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->sysUrisScheduledForDeletion !== null) {
                if (!$this->sysUrisScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysUriQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\model\domain\SysModule
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\model\domain\SysModule The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\model\domain\SysModule (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\model\domain\SysModule Clone of current object.
     * @throws PropelException
     */
     ...
     */
    public function resetPartialSysUris($v = true)
    {
     ...
     * @return void
     */
    public function initSysUris($overrideExisting = true)
    {
        ...
        $this->collSysUris->setModel('\App\model\domain\SysUri');
    }
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSysModule The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSysUris(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSysUrisPartial && !$this->isNew();
        if (null === $this->collSysUris || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collSysUris) {
     ...
     */
    protected function doAddSysUri(ChildSysUri $sysUri)
    {
