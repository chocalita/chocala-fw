 ...
 *
 * @method     \App\model\domain\SysEventUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SysEventQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\model\domain\Base\SysEventQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\model\\domain\\SysEvent', $modelAlias = null)
    {
