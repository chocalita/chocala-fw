...
abstract class SysEntityType implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SysEntityTypeTableMap';
    ...
    /**
     * Initializes internal state of Base\SysEntityType object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SysEntityType'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->jobEmpresaSuscritasScheduledForDeletion !== null) {
                if (!$this->jobEmpresaSuscritasScheduledForDeletion->isEmpty()) {
                    \JobEmpresaSuscritaQuery::create()
                        ->filterByPrimaryKeys($this->jobEmpresaSuscritasScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SysEntityType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SysEntityType Clone of current object.
     * @throws PropelException
     */
    ...
    public function setJobEmpresaSuscritas(Collection $jobEmpresaSuscritas, ConnectionInterface $con = null)
    {
        ...
        foreach ($jobEmpresaSuscritasToDelete as $jobEmpresaSuscritaRemoved) {
            $jobEmpresaSuscritaRemoved->setSysEntityType(null);
        }
    ...
    protected function doAddJobEmpresaSuscrita(ChildJobEmpresaSuscrita $jobEmpresaSuscrita)
    {
        ...
        $jobEmpresaSuscrita->setSysEntityType($this);
    }
    ...
    public function removeJobEmpresaSuscrita(ChildJobEmpresaSuscrita $jobEmpresaSuscrita)
    {
        if ($this->getJobEmpresaSuscritas()->contains($jobEmpresaSuscrita)) {
            ...
            $this->jobEmpresaSuscritasScheduledForDeletion[]= clone $jobEmpresaSuscrita;
            $jobEmpresaSuscrita->setSysEntityType(null);
        }
     ...
     * @return ObjectCollection|ChildJobEmpresaSuscrita[] List of ChildJobEmpresaSuscrita objects
     */
    public function getJobEmpresaSuscritasJoinSysLocation(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildJobEmpresaSuscritaQuery::create(null, $criteria);
