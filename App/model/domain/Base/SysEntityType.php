...
use App\model\domain\SysEntityType as ChildSysEntityType;
use App\model\domain\SysEntityTypeQuery as ChildSysEntityTypeQuery;
use App\model\domain\Map\SysEntityTableMap;
use App\model\domain\Map\SysEntityTypeTableMap;
...
abstract class SysEntityType implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\model\\domain\\Map\\SysEntityTypeTableMap';
    ...
    /**
     * Initializes internal state of App\model\domain\Base\SysEntityType object.
     */
    ...
    /**
     * Compares this with another <code>SysEntityType</code> instance.  If
     * <code>obj</code> is an instance of <code>SysEntityType</code>, delegates to
     * <code>equals(SysEntityType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SysEntityType The current object, for fluid interface
     */
     ...
     * @return $this|\App\model\domain\SysEntityType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SysEntityTypeTableMap::COL_ID] = true;
        }
    ...
    public function setGroupCode($v)
    {
        ...
        if ($this->group_code !== $v) {
            $this->group_code = $v;
            $this->modifiedColumns[SysEntityTypeTableMap::COL_GROUP_CODE] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[SysEntityTypeTableMap::COL_CODE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SysEntityTypeTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[SysEntityTypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SysEntityTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SysEntityTypeTableMap::translateFieldName('GroupCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SysEntityTypeTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SysEntityTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SysEntityTypeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = SysEntityTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\model\\domain\\SysEntityType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSysEntityTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SysEntityType::setDeleted()
     * @see SysEntityType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSysEntityTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SysEntityTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->sysEntitiesScheduledForDeletion !== null) {
                if (!$this->sysEntitiesScheduledForDeletion->isEmpty()) {
                    \App\model\domain\SysEntityQuery::create()
                        ->filterByPrimaryKeys($this->sysEntitiesScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SysEntityTypeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SysEntityTypeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_GROUP_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'GROUP_CODE';
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'CODE';
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRIPTION';
        }

        $sql = sprintf(
            'INSERT INTO sys_entity_type (%s) VALUES (%s)',
    ...
    {
        $pos = SysEntityTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SysEntityType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SysEntityType'][$this->hashCode()] = true;
        $keys = SysEntityTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getGroupCode(),
            $keys[2] => $this->getCode(),
            $keys[3] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\model\domain\SysEntityType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\model\domain\SysEntityType The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(SysEntityTypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SysEntityTypeTableMap::COL_ID)) {
            $criteria->add(SysEntityTypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_GROUP_CODE)) {
            $criteria->add(SysEntityTypeTableMap::COL_GROUP_CODE, $this->group_code);
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_CODE)) {
            $criteria->add(SysEntityTypeTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_NAME)) {
            $criteria->add(SysEntityTypeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SysEntityTypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(SysEntityTypeTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildSysEntityTypeQuery::create();
        $criteria->add(SysEntityTypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\model\domain\SysEntityType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\model\domain\SysEntityType Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSysEntities($overrideExisting = true)
    {
        ...
        $this->collSysEntities->setModel('\App\model\domain\SysEntity');
    }
     ...
     * If this ChildSysEntityType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSysEntityType The current object (for fluent API support)
     */
    public function setSysEntities(Collection $sysEntities, ConnectionInterface $con = null)
    {
        ...
        foreach ($sysEntitiesToDelete as $sysEntityRemoved) {
            $sysEntityRemoved->setSysEntityType(null);
        }
    ...
    protected function doAddSysEntity(ChildSysEntity $sysEntity)
    {
        ...
        $sysEntity->setSysEntityType($this);
    }
    ...
    public function removeSysEntity(ChildSysEntity $sysEntity)
    {
        if ($this->getSysEntities()->contains($sysEntity)) {
            ...
            $this->sysEntitiesScheduledForDeletion[]= clone $sysEntity;
            $sysEntity->setSysEntityType(null);
        }
     ...
     * Otherwise if this SysEntityType is new, it will return
     * an empty collection; or if this SysEntityType has previously
     * been saved, it will retrieve related SysEntities from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SysEntityType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildSysEntity[] List of ChildSysEntity objects
     */
    public function getSysEntitiesJoinSysLocation(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSysEntityQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(SysEntityTypeTableMap::DEFAULT_STRING_FORMAT);
    }
