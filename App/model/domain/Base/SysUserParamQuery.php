 ...
 *
 * @method     ChildSysUserParam|null findOne(?ConnectionInterface $con = null) Return the first ChildSysUserParam matching the query
 ...
 *
 * @method     ChildSysUserParam|null findOneById(int $ID) Return the first ChildSysUserParam filtered by the ID column
 * @method     ChildSysUserParam|null findOneByUserId(int $USER_ID) Return the first ChildSysUserParam filtered by the USER_ID column
 * @method     ChildSysUserParam|null findOneByParamId(int $PARAM_ID) Return the first ChildSysUserParam filtered by the PARAM_ID column
 * @method     ChildSysUserParam|null findOneByValue(string $VALUE) Return the first ChildSysUserParam filtered by the VALUE column
 * @method     ChildSysUserParam|null findOneByDescription(string $DESCRIPTION) Return the first ChildSysUserParam filtered by the DESCRIPTION column
 * @method     ChildSysUserParam|null findOneByLastUserId(int $LAST_USER_ID) Return the first ChildSysUserParam filtered by the LAST_USER_ID column
 * @method     ChildSysUserParam|null findOneByCreationDate(string $CREATION_DATE) Return the first ChildSysUserParam filtered by the CREATION_DATE column
 * @method     ChildSysUserParam|null findOneByModificationDate(string $MODIFICATION_DATE) Return the first ChildSysUserParam filtered by the MODIFICATION_DATE column
 *
 ...
 *
 * @method     ChildSysUserParam[]|Collection find(?ConnectionInterface $con = null) Return ChildSysUserParam objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSysUserParam> find(?ConnectionInterface $con = null) Return ChildSysUserParam objects based on current ModelCriteria
 *
 * @method     ChildSysUserParam[]|Collection findById(int|array<int> $ID) Return ChildSysUserParam objects filtered by the ID column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findById(int|array<int> $ID) Return ChildSysUserParam objects filtered by the ID column
 * @method     ChildSysUserParam[]|Collection findByUserId(int|array<int> $USER_ID) Return ChildSysUserParam objects filtered by the USER_ID column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findByUserId(int|array<int> $USER_ID) Return ChildSysUserParam objects filtered by the USER_ID column
 * @method     ChildSysUserParam[]|Collection findByParamId(int|array<int> $PARAM_ID) Return ChildSysUserParam objects filtered by the PARAM_ID column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findByParamId(int|array<int> $PARAM_ID) Return ChildSysUserParam objects filtered by the PARAM_ID column
 * @method     ChildSysUserParam[]|Collection findByValue(string|array<string> $VALUE) Return ChildSysUserParam objects filtered by the VALUE column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findByValue(string|array<string> $VALUE) Return ChildSysUserParam objects filtered by the VALUE column
 * @method     ChildSysUserParam[]|Collection findByDescription(string|array<string> $DESCRIPTION) Return ChildSysUserParam objects filtered by the DESCRIPTION column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findByDescription(string|array<string> $DESCRIPTION) Return ChildSysUserParam objects filtered by the DESCRIPTION column
 * @method     ChildSysUserParam[]|Collection findByLastUserId(int|array<int> $LAST_USER_ID) Return ChildSysUserParam objects filtered by the LAST_USER_ID column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findByLastUserId(int|array<int> $LAST_USER_ID) Return ChildSysUserParam objects filtered by the LAST_USER_ID column
 * @method     ChildSysUserParam[]|Collection findByCreationDate(string|array<string> $CREATION_DATE) Return ChildSysUserParam objects filtered by the CREATION_DATE column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findByCreationDate(string|array<string> $CREATION_DATE) Return ChildSysUserParam objects filtered by the CREATION_DATE column
 * @method     ChildSysUserParam[]|Collection findByModificationDate(string|array<string> $MODIFICATION_DATE) Return ChildSysUserParam objects filtered by the MODIFICATION_DATE column
 * @psalm-method Collection&\Traversable<ChildSysUserParam> findByModificationDate(string|array<string> $MODIFICATION_DATE) Return ChildSysUserParam objects filtered by the MODIFICATION_DATE column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSysUserParam> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class SysUserParamQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByUserId($userId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_USER_ID, $userId, $comparison);
    ...
    public function filterByParamId($paramId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_PARAM_ID, $paramId, $comparison);
    ...
    public function filterByValue($value = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_VALUE, $value, $comparison);
    ...
    public function filterByDescription($description = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_DESCRIPTION, $description, $comparison);
    ...
    public function filterByLastUserId($lastUserId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_LAST_USER_ID, $lastUserId, $comparison);
    ...
    public function filterByCreationDate($creationDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_CREATION_DATE, $creationDate, $comparison);
    ...
    public function filterByModificationDate($modificationDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysUserParamTableMap::COL_MODIFICATION_DATE, $modificationDate, $comparison);
