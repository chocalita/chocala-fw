...
abstract class SysAuth implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SysAuthTableMap';
    ...
    /**
     * Initializes internal state of Base\SysAuth object.
     * @see applyDefaults()
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SysAuth'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SysAuth (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SysAuth Clone of current object.
     * @throws PropelException
     */
