 ...
 *
 * @method     ChildSysEmailSent|null findOne(?ConnectionInterface $con = null) Return the first ChildSysEmailSent matching the query
 ...
 *
 * @method     ChildSysEmailSent|null findOneById(int $ID) Return the first ChildSysEmailSent filtered by the ID column
 * @method     ChildSysEmailSent|null findOneByEmailId(int $EMAIL_ID) Return the first ChildSysEmailSent filtered by the EMAIL_ID column
 * @method     ChildSysEmailSent|null findOneByUserId(int $USER_ID) Return the first ChildSysEmailSent filtered by the USER_ID column
 * @method     ChildSysEmailSent|null findOneBySenderId(int $SENDER_ID) Return the first ChildSysEmailSent filtered by the SENDER_ID column
 * @method     ChildSysEmailSent|null findOneByHashString(string $HASH_STRING) Return the first ChildSysEmailSent filtered by the HASH_STRING column
 * @method     ChildSysEmailSent|null findOneByFromName(string $FROM_NAME) Return the first ChildSysEmailSent filtered by the FROM_NAME column
 * @method     ChildSysEmailSent|null findOneByFromEmail(string $FROM_EMAIL) Return the first ChildSysEmailSent filtered by the FROM_EMAIL column
 * @method     ChildSysEmailSent|null findOneByToEmail(string $TO_EMAIL) Return the first ChildSysEmailSent filtered by the TO_EMAIL column
 * @method     ChildSysEmailSent|null findOneByCc(string $CC) Return the first ChildSysEmailSent filtered by the CC column
 * @method     ChildSysEmailSent|null findOneByBcc(string $BCC) Return the first ChildSysEmailSent filtered by the BCC column
 * @method     ChildSysEmailSent|null findOneBySubject(string $SUBJECT) Return the first ChildSysEmailSent filtered by the SUBJECT column
 * @method     ChildSysEmailSent|null findOneByContent(string $CONTENT) Return the first ChildSysEmailSent filtered by the CONTENT column
 * @method     ChildSysEmailSent|null findOneByIsSuccess(boolean $IS_SUCCESS) Return the first ChildSysEmailSent filtered by the IS_SUCCESS column
 * @method     ChildSysEmailSent|null findOneByShippingDate(string $SHIPPING_DATE) Return the first ChildSysEmailSent filtered by the SHIPPING_DATE column
 * @method     ChildSysEmailSent|null findOneByOpeningDate(string $OPENING_DATE) Return the first ChildSysEmailSent filtered by the OPENING_DATE column
 *
 ...
 *
 * @method     ChildSysEmailSent[]|Collection find(?ConnectionInterface $con = null) Return ChildSysEmailSent objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> find(?ConnectionInterface $con = null) Return ChildSysEmailSent objects based on current ModelCriteria
 *
 * @method     ChildSysEmailSent[]|Collection findById(int|array<int> $ID) Return ChildSysEmailSent objects filtered by the ID column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findById(int|array<int> $ID) Return ChildSysEmailSent objects filtered by the ID column
 * @method     ChildSysEmailSent[]|Collection findByEmailId(int|array<int> $EMAIL_ID) Return ChildSysEmailSent objects filtered by the EMAIL_ID column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByEmailId(int|array<int> $EMAIL_ID) Return ChildSysEmailSent objects filtered by the EMAIL_ID column
 * @method     ChildSysEmailSent[]|Collection findByUserId(int|array<int> $USER_ID) Return ChildSysEmailSent objects filtered by the USER_ID column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByUserId(int|array<int> $USER_ID) Return ChildSysEmailSent objects filtered by the USER_ID column
 * @method     ChildSysEmailSent[]|Collection findBySenderId(int|array<int> $SENDER_ID) Return ChildSysEmailSent objects filtered by the SENDER_ID column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findBySenderId(int|array<int> $SENDER_ID) Return ChildSysEmailSent objects filtered by the SENDER_ID column
 * @method     ChildSysEmailSent[]|Collection findByHashString(string|array<string> $HASH_STRING) Return ChildSysEmailSent objects filtered by the HASH_STRING column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByHashString(string|array<string> $HASH_STRING) Return ChildSysEmailSent objects filtered by the HASH_STRING column
 * @method     ChildSysEmailSent[]|Collection findByFromName(string|array<string> $FROM_NAME) Return ChildSysEmailSent objects filtered by the FROM_NAME column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByFromName(string|array<string> $FROM_NAME) Return ChildSysEmailSent objects filtered by the FROM_NAME column
 * @method     ChildSysEmailSent[]|Collection findByFromEmail(string|array<string> $FROM_EMAIL) Return ChildSysEmailSent objects filtered by the FROM_EMAIL column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByFromEmail(string|array<string> $FROM_EMAIL) Return ChildSysEmailSent objects filtered by the FROM_EMAIL column
 * @method     ChildSysEmailSent[]|Collection findByToEmail(string|array<string> $TO_EMAIL) Return ChildSysEmailSent objects filtered by the TO_EMAIL column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByToEmail(string|array<string> $TO_EMAIL) Return ChildSysEmailSent objects filtered by the TO_EMAIL column
 * @method     ChildSysEmailSent[]|Collection findByCc(string|array<string> $CC) Return ChildSysEmailSent objects filtered by the CC column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByCc(string|array<string> $CC) Return ChildSysEmailSent objects filtered by the CC column
 * @method     ChildSysEmailSent[]|Collection findByBcc(string|array<string> $BCC) Return ChildSysEmailSent objects filtered by the BCC column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByBcc(string|array<string> $BCC) Return ChildSysEmailSent objects filtered by the BCC column
 * @method     ChildSysEmailSent[]|Collection findBySubject(string|array<string> $SUBJECT) Return ChildSysEmailSent objects filtered by the SUBJECT column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findBySubject(string|array<string> $SUBJECT) Return ChildSysEmailSent objects filtered by the SUBJECT column
 * @method     ChildSysEmailSent[]|Collection findByContent(string|array<string> $CONTENT) Return ChildSysEmailSent objects filtered by the CONTENT column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByContent(string|array<string> $CONTENT) Return ChildSysEmailSent objects filtered by the CONTENT column
 * @method     ChildSysEmailSent[]|Collection findByIsSuccess(boolean|array<boolean> $IS_SUCCESS) Return ChildSysEmailSent objects filtered by the IS_SUCCESS column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByIsSuccess(boolean|array<boolean> $IS_SUCCESS) Return ChildSysEmailSent objects filtered by the IS_SUCCESS column
 * @method     ChildSysEmailSent[]|Collection findByShippingDate(string|array<string> $SHIPPING_DATE) Return ChildSysEmailSent objects filtered by the SHIPPING_DATE column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByShippingDate(string|array<string> $SHIPPING_DATE) Return ChildSysEmailSent objects filtered by the SHIPPING_DATE column
 * @method     ChildSysEmailSent[]|Collection findByOpeningDate(string|array<string> $OPENING_DATE) Return ChildSysEmailSent objects filtered by the OPENING_DATE column
 * @psalm-method Collection&\Traversable<ChildSysEmailSent> findByOpeningDate(string|array<string> $OPENING_DATE) Return ChildSysEmailSent objects filtered by the OPENING_DATE column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSysEmailSent> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class SysEmailSentQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_ID, $id, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByEmailId($emailId = null, ?string $comparison = null)
    {
        if (is_array($emailId)) {
            $useMinMax = false;
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_EMAIL_ID, $emailId, $comparison);
    ...
    public function filterByUserId($userId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_USER_ID, $userId, $comparison);
    ...
    public function filterBySenderId($senderId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_SENDER_ID, $senderId, $comparison);
    ...
    public function filterByHashString($hashString = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_HASH_STRING, $hashString, $comparison);
    ...
    public function filterByFromName($fromName = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_FROM_NAME, $fromName, $comparison);
    ...
    public function filterByFromEmail($fromEmail = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_FROM_EMAIL, $fromEmail, $comparison);
    ...
    public function filterByToEmail($toEmail = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_TO_EMAIL, $toEmail, $comparison);
    ...
    public function filterByCc($cc = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_CC, $cc, $comparison);
    ...
    public function filterByBcc($bcc = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_BCC, $bcc, $comparison);
    ...
    public function filterBySubject($subject = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_SUBJECT, $subject, $comparison);
    ...
    public function filterByContent($content = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_CONTENT, $content, $comparison);
     ...
     * </code>
     *
     * @param bool|string $isSuccess The value to use as filter.
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByIsSuccess($isSuccess = null, ?string $comparison = null)
    {
        if (is_string($isSuccess)) {
            $isSuccess = in_array(strtolower($isSuccess), array('false', 'off', '-', 'no', 'n', '0', ''), true) ? false : true;
        }

        $this->addUsingAlias(SysEmailSentTableMap::COL_IS_SUCCESS, $isSuccess, $comparison);
    ...
    public function filterByShippingDate($shippingDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_SHIPPING_DATE, $shippingDate, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByOpeningDate($openingDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysEmailSentTableMap::COL_OPENING_DATE, $openingDate, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySysEmail($sysEmail, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSysEmail(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
     ...
     * Use the SysEmail relation SysEmail object
     *
     * @param callable(\SysEmailQuery):\SysEmailQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @return $this
     */
    public function withSysEmailQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useSysEmailQuery(
            $relationAlias,
            $joinType
        );
    ...
    /**
     * Use the relation to SysEmail table for an EXISTS query.
     *
     ...
     *
     * @return \SysEmailQuery The inner query object of the EXISTS statement
     */
    public function useSysEmailExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \SysEmailQuery */
        $q = $this->useExistsQuery('SysEmail', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the relation to SysEmail table for a NOT EXISTS query.
     *
     * @see useSysEmailExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \SysEmailQuery The inner query object of the NOT EXISTS statement
     */
    public function useSysEmailNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \SysEmailQuery */
        $q = $this->useExistsQuery('SysEmail', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to SysEmail table for an IN query.
     *
     ...
     *
     * @return \SysEmailQuery The inner query object of the IN statement
     */
    public function useInSysEmailQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \SysEmailQuery */
        $q = $this->useInQuery('SysEmail', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to SysEmail table for a NOT IN query.
     *
     * @see useSysEmailInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \SysEmailQuery The inner query object of the NOT IN statement
     */
    public function useNotInSysEmailQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \SysEmailQuery */
        $q = $this->useInQuery('SysEmail', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSysUser(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
