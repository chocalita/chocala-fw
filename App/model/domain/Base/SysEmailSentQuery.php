 ...
 *
 * @method     \App\model\domain\SysEmailQuery|\App\model\domain\SysUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SysEmailSentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\model\domain\Base\SysEmailSentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\model\\domain\\SysEmailSent', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\model\domain\SysEmail object
     *
     * @param \App\model\domain\SysEmail|ObjectCollection $sysEmail The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($sysEmail instanceof \App\model\domain\SysEmail) {
            return $this
            ...
            throw new PropelException('filterBySysEmail() only accepts arguments of type \App\model\domain\SysEmail or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\model\domain\SysEmailQuery A secondary query class using the current class as primary query
     */
    public function useSysEmailQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSysEmail($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SysEmail', '\App\model\domain\SysEmailQuery');
    }
