 ...
 *
 * @method     ChildSysAuth|null findOne(?ConnectionInterface $con = null) Return the first ChildSysAuth matching the query
 ...
 *
 * @method     ChildSysAuth|null findOneById(int $ID) Return the first ChildSysAuth filtered by the ID column
 * @method     ChildSysAuth|null findOneByUserId(int $USER_ID) Return the first ChildSysAuth filtered by the USER_ID column
 * @method     ChildSysAuth|null findOneByType(string $TYPE) Return the first ChildSysAuth filtered by the TYPE column
 * @method     ChildSysAuth|null findOneByAccessToken(string $ACCESS_TOKEN) Return the first ChildSysAuth filtered by the ACCESS_TOKEN column
 * @method     ChildSysAuth|null findOneByJson(string $JSON) Return the first ChildSysAuth filtered by the JSON column
 * @method     ChildSysAuth|null findOneByStatus(string $STATUS) Return the first ChildSysAuth filtered by the STATUS column
 * @method     ChildSysAuth|null findOneByCreationDate(string $CREATION_DATE) Return the first ChildSysAuth filtered by the CREATION_DATE column
 * @method     ChildSysAuth|null findOneByModificationDate(string $MODIFICATION_DATE) Return the first ChildSysAuth filtered by the MODIFICATION_DATE column
 *
 ...
 *
 * @method     ChildSysAuth[]|Collection find(?ConnectionInterface $con = null) Return ChildSysAuth objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSysAuth> find(?ConnectionInterface $con = null) Return ChildSysAuth objects based on current ModelCriteria
 *
 * @method     ChildSysAuth[]|Collection findById(int|array<int> $ID) Return ChildSysAuth objects filtered by the ID column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findById(int|array<int> $ID) Return ChildSysAuth objects filtered by the ID column
 * @method     ChildSysAuth[]|Collection findByUserId(int|array<int> $USER_ID) Return ChildSysAuth objects filtered by the USER_ID column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findByUserId(int|array<int> $USER_ID) Return ChildSysAuth objects filtered by the USER_ID column
 * @method     ChildSysAuth[]|Collection findByType(string|array<string> $TYPE) Return ChildSysAuth objects filtered by the TYPE column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findByType(string|array<string> $TYPE) Return ChildSysAuth objects filtered by the TYPE column
 * @method     ChildSysAuth[]|Collection findByAccessToken(string|array<string> $ACCESS_TOKEN) Return ChildSysAuth objects filtered by the ACCESS_TOKEN column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findByAccessToken(string|array<string> $ACCESS_TOKEN) Return ChildSysAuth objects filtered by the ACCESS_TOKEN column
 * @method     ChildSysAuth[]|Collection findByJson(string|array<string> $JSON) Return ChildSysAuth objects filtered by the JSON column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findByJson(string|array<string> $JSON) Return ChildSysAuth objects filtered by the JSON column
 * @method     ChildSysAuth[]|Collection findByStatus(string|array<string> $STATUS) Return ChildSysAuth objects filtered by the STATUS column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findByStatus(string|array<string> $STATUS) Return ChildSysAuth objects filtered by the STATUS column
 * @method     ChildSysAuth[]|Collection findByCreationDate(string|array<string> $CREATION_DATE) Return ChildSysAuth objects filtered by the CREATION_DATE column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findByCreationDate(string|array<string> $CREATION_DATE) Return ChildSysAuth objects filtered by the CREATION_DATE column
 * @method     ChildSysAuth[]|Collection findByModificationDate(string|array<string> $MODIFICATION_DATE) Return ChildSysAuth objects filtered by the MODIFICATION_DATE column
 * @psalm-method Collection&\Traversable<ChildSysAuth> findByModificationDate(string|array<string> $MODIFICATION_DATE) Return ChildSysAuth objects filtered by the MODIFICATION_DATE column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSysAuth> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class SysAuthQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByUserId($userId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_USER_ID, $userId, $comparison);
    ...
    public function filterByType($type = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_TYPE, $type, $comparison);
    ...
    public function filterByAccessToken($accessToken = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_ACCESS_TOKEN, $accessToken, $comparison);
     ...
     * $query->filterByJson(['foo', 'bar']); // WHERE JSON IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $json The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByJson($json = null, ?string $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($json)) {
                $comparison = Criteria::IN;
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_JSON, $json, $comparison);
    ...
    public function filterByStatus($status = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_STATUS, $status, $comparison);
    ...
    public function filterByCreationDate($creationDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_CREATION_DATE, $creationDate, $comparison);
    ...
    public function filterByModificationDate($modificationDate = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SysAuthTableMap::COL_MODIFICATION_DATE, $modificationDate, $comparison);
