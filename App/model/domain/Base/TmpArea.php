...
abstract class TmpArea implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TmpAreaTableMap';
    ...
    /**
     * Compares this with another <code>TmpArea</code> instance.  If
     * <code>obj</code> is an instance of <code>TmpArea</code>, delegates to
     * <code>equals(TmpArea)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TmpArea The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TmpAreaTableMap::COL_ID] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[TmpAreaTableMap::COL_NOMBRE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TmpAreaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TmpAreaTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TmpAreaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TmpArea'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTmpAreaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TmpArea::setDeleted()
     * @see TmpArea::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTmpAreaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TmpAreaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TmpAreaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TmpAreaTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }

        $sql = sprintf(
            'INSERT INTO tmp_area (%s) VALUES (%s)',
    ...
    {
        $pos = TmpAreaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['TmpArea'][$this->hashCode()] = true;
        $keys = TmpAreaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TmpAreaTableMap::COL_ID)) {
            $criteria->add(TmpAreaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TmpAreaTableMap::COL_NOMBRE)) {
            $criteria->add(TmpAreaTableMap::COL_NOMBRE, $this->nombre);
        }
    ...
    {
        $criteria = ChildTmpAreaQuery::create();
        $criteria->add(TmpAreaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TmpArea (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TmpArea Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(TmpAreaTableMap::DEFAULT_STRING_FORMAT);
    }
