...
abstract class TmpFormacion implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TmpFormacionTableMap';
    ...
    /**
     * Compares this with another <code>TmpFormacion</code> instance.  If
     * <code>obj</code> is an instance of <code>TmpFormacion</code>, delegates to
     * <code>equals(TmpFormacion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TmpFormacion The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TmpFormacionTableMap::COL_ID] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[TmpFormacionTableMap::COL_NOMBRE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TmpFormacionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTmpFormacionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TmpFormacion::setDeleted()
     * @see TmpFormacion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTmpFormacionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TmpFormacionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TmpFormacionTableMap::COL_ID)) {
    ...
    {
        $pos = TmpFormacionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['TmpFormacion'][$this->hashCode()] = true;
        $keys = TmpFormacionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TmpFormacionTableMap::COL_ID)) {
            $criteria->add(TmpFormacionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TmpFormacionTableMap::COL_NOMBRE)) {
    ...
    {
        $criteria = ChildTmpFormacionQuery::create();
        $criteria->add(TmpFormacionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TmpFormacion (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TmpFormacion Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(TmpFormacionTableMap::DEFAULT_STRING_FORMAT);
    }
