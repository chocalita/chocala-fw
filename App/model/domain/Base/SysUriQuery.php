 ...
 *
 * @method     \App\model\domain\SysModuleQuery|\App\model\domain\SysRolXUriQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SysUriQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\model\domain\Base\SysUriQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\model\\domain\\SysUri', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\model\domain\SysModule object
     *
     * @param \App\model\domain\SysModule|ObjectCollection $sysModule The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($sysModule instanceof \App\model\domain\SysModule) {
            return $this
            ...
            throw new PropelException('filterBySysModule() only accepts arguments of type \App\model\domain\SysModule or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\model\domain\SysModuleQuery A secondary query class using the current class as primary query
     */
    public function useSysModuleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSysModule($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SysModule', '\App\model\domain\SysModuleQuery');
    }
