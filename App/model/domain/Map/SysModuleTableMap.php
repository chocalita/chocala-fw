...
class SysModuleTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'sys_module.ID';

    /**
     * the column name for the NAME field
     */
    const COL_NAME = 'sys_module.NAME';

    /**
     * the column name for the URI field
     */
    const COL_URI = 'sys_module.URI';

    /**
     * the column name for the ACCESS field
     */
    const COL_ACCESS = 'sys_module.ACCESS';

    /**
     * the column name for the POSITION field
     */
    const COL_POSITION = 'sys_module.POSITION';

    /**
     * the column name for the DESCRIPTION field
     */
    const COL_DESCRIPTION = 'sys_module.DESCRIPTION';

    /**
     * the column name for the ICON_CLASS field
     */
    const COL_ICON_CLASS = 'sys_module.ICON_CLASS';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Uri', 'Access', 'Position', 'Description', 'IconClass', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'uri', 'access', 'position', 'description', 'iconClass', ),
        self::TYPE_COLNAME       => array(SysModuleTableMap::COL_ID, SysModuleTableMap::COL_NAME, SysModuleTableMap::COL_URI, SysModuleTableMap::COL_ACCESS, SysModuleTableMap::COL_POSITION, SysModuleTableMap::COL_DESCRIPTION, SysModuleTableMap::COL_ICON_CLASS, ),
        self::TYPE_FIELDNAME     => array('ID', 'NAME', 'URI', 'ACCESS', 'POSITION', 'DESCRIPTION', 'ICON_CLASS', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Uri' => 2, 'Access' => 3, 'Position' => 4, 'Description' => 5, 'IconClass' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'uri' => 2, 'access' => 3, 'position' => 4, 'description' => 5, 'iconClass' => 6, ),
        self::TYPE_COLNAME       => array(SysModuleTableMap::COL_ID => 0, SysModuleTableMap::COL_NAME => 1, SysModuleTableMap::COL_URI => 2, SysModuleTableMap::COL_ACCESS => 3, SysModuleTableMap::COL_POSITION => 4, SysModuleTableMap::COL_DESCRIPTION => 5, SysModuleTableMap::COL_ICON_CLASS => 6, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'NAME' => 1, 'URI' => 2, 'ACCESS' => 3, 'POSITION' => 4, 'DESCRIPTION' => 5, 'ICON_CLASS' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
  ...
  array (
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SysModuleTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SysModuleTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SysModuleTableMap());
        }
    }
...
//
SysModuleTableMap::buildTableMap();
