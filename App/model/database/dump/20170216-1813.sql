...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-02-2017 a las 22:23:39
...
-- Funciones
--
CREATE DEFINER=`root`@`localhost` FUNCTION `busca_avisos` (`p_areas` VARCHAR(500), `p_formaciones` VARCHAR(500)) RETURNS VARCHAR(200) CHARSET utf8 COLLATE utf8_german2_ci BEGIN
    ...
    -- declaracion de cursor de areas
    ...
    -- declaracion de cursor de formaciones
        ...
        WHILE v_item_area_formacion != '' DO
            ...
            SELECT COUNT(*)
             ...
             WHERE fecha_vencimiento IS NOT NULL
               ...
               AND areas LIKE CONCAT('%',v_item_area_formacion,'%');
        	IF v_count > 0 THEN
                -- busca todos los avisos relacionados al area
                SET v_idx_cursor := 0;
                OPEN cursor_areas;
                WHILE v_idx_cursor < v_count DO
                    FETCH cursor_areas INTO v_id_aviso, v_cargo;
                    -- verifica si ya esta guardado previamente
                ...
                CLOSE cursor_areas;
            END IF;
            -- para el siguiente area
			SET v_idx_split = v_idx_split + 1;
            SET v_item_area_formacion = split(p_areas, ';', v_idx_split);
        END WHILE;
    END IF;

    -- busqueda de avisos x formaciones
        ...
        WHILE v_item_area_formacion != '' DO
            ...
            SELECT COUNT(*)
             ...
             WHERE fecha_vencimiento IS NOT NULL
               ...
               AND nivel_formacion LIKE CONCAT('%',v_item_area_formacion,'%');
        	IF v_count > 0 THEN
                -- busca todos los avisos relacionados a la formacion
                SET v_idx_cursor := 0;
...
CREATE TABLE `job_area_habilidad` (
  `ID` int(11) NOT NULL,
  `NOMBRE` varchar(100) NOT NULL,
  `DESCRIPCION` text,
...
CREATE TABLE `job_area_relacionada` (
...
CREATE TABLE `job_area_tecnica_profesion` (
...
CREATE TABLE `job_aviso` (
  ...
  `FORMACIONES` varchar(2000) DEFAULT NULL,
  `STATUS` varchar(10) NOT NULL DEFAULT 'ACTIVE',
...
(137, 5, NULL, NULL, 'Profesional en Comercio Exterior', '*Ver imagen', 'EBA', NULL, 0, NULL, '2017-02-12', '2017-02-17', '*Ver imagen', 3, 'TECNICO', NULL, NULL, ' La Razón', 1, NULL, NULL, NULL, 'ACTIVE', '1', '2017-02-14 04:00:00', NULL),
...
CREATE TABLE `job_formacion_academica` (
  `ID` int(11) NOT NULL,
...
CREATE TABLE `job_oficio_curriculum` (
...
CREATE TABLE `job_tipo_formacion` (
  `ID` int(11) NOT NULL,
  `CODIGO` varchar(30) NOT NULL,
...
CREATE TABLE `scrap_tipo_empresa` (
  `ID` int(11) NOT NULL,
  `NOMBRE` varchar(200) NOT NULL,
  `DESCRIPCION` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8 PACK_KEYS=0;
...
CREATE TABLE `sys_entity_branch` (
  `ID` int(11) NOT NULL,
...
CREATE TABLE `sys_password_request` (
  `ID` int(11) NOT NULL,
  `USER_ID` int(11) NOT NULL,
  `EMAIL` varchar(200) NOT NULL,
  `HASH_STRING` varchar(500) NOT NULL,
...
CREATE TABLE `sys_user` (
  ...
  `CREATION_DATE` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `MODIFICATION_DATE` timestamp NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB AVG_ROW_LENGTH=455 DEFAULT CHARSET=utf8;
...
--
-- Indices de la tabla `job_area`
--
ALTER TABLE `job_area`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `job_area_habilidad`
--
ALTER TABLE `job_area_habilidad`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `job_area_relacionada`
--
ALTER TABLE `job_area_relacionada`
  ADD PRIMARY KEY (`ID_AREA_1`,`ID_AREA_2`),
  ADD KEY `ID_AREA_1` (`ID_AREA_1`),
  ADD KEY `ID_AREA_2` (`ID_AREA_2`);

--
-- Indices de la tabla `job_area_tecnica`
--
ALTER TABLE `job_area_tecnica`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `job_area_tecnica_profesion`
--
ALTER TABLE `job_area_tecnica_profesion`
  ADD PRIMARY KEY (`ID_AREA_TECNICA`,`ID_PROFESION`),
  ADD KEY `ID_AREA_TECNICA` (`ID_AREA_TECNICA`),
  ADD KEY `ID_PROFESION` (`ID_PROFESION`);

--
-- Indices de la tabla `job_aviso`
--
ALTER TABLE `job_aviso`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `FORMACION_ACADEMICA_ID` (`NIVEL_FORMACION`),
  ADD KEY `AREA_ID` (`AREA_ID`),
  ADD KEY `AREA_TECNICA_ID` (`AREA_TECNICA_ID`);

--
-- Indices de la tabla `job_curriculum`
--
...
--
-- Indices de la tabla `job_formacion_academica`
--
ALTER TABLE `job_formacion_academica`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `ID_TIPO_ESTUDIO` (`ID_TIPO_FORMACION`),
  ADD KEY `ID_PROFESION` (`ID_PROFESION`),
  ADD KEY `ID_CURRICULUM` (`ID_CURRICULUM`);

--
-- Indices de la tabla `job_oficio`
--
ALTER TABLE `job_oficio`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `job_oficio_curriculum`
--
ALTER TABLE `job_oficio_curriculum`
  ADD PRIMARY KEY (`ID_CURRICULUM`,`ID_OFICIO`),
  ADD KEY `ID_OFICIO` (`ID_OFICIO`),
  ADD KEY `ID_CURRICULUM` (`ID_CURRICULUM`);

--
-- Indices de la tabla `job_profesion`
--
...
--
-- Indices de la tabla `job_tipo_formacion`
--
ALTER TABLE `job_tipo_formacion`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `scrap_actividad`
--
ALTER TABLE `scrap_actividad`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `scrap_empresa`
--
ALTER TABLE `scrap_empresa`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `ID_ACTIVIDAD` (`ID_ACTIVIDAD`),
  ADD KEY `ID_ACTIVIDAD_2` (`ID_ACTIVIDAD`,`ID_TIPO_EMPRESA`),
  ADD KEY `ID_TIPO_EMPRESA` (`ID_TIPO_EMPRESA`),
  ADD KEY `ID_PAGINA` (`ID_PAGINA`);

--
-- Indices de la tabla `scrap_pagina`
--
ALTER TABLE `scrap_pagina`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `scrap_tipo_empresa`
--
ALTER TABLE `scrap_tipo_empresa`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `sys_email`
--
ALTER TABLE `sys_email`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_SYS_EMAIL_CODE` (`CODE`);

--
-- Indices de la tabla `sys_email_sent`
--
...
--
-- Indices de la tabla `sys_entity`
--
ALTER TABLE `sys_entity`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_SYS_ENTITY_NIT` (`NIT`),
  ADD KEY `ENTITY_TYPE_ID` (`ENTITY_TYPE_ID`),
  ADD KEY `LOCATION_ID` (`LOCATION_ID`),
  ADD KEY `IDX_SYS_ENTITY_FORMAL_NAME` (`FORMAL_NAME`(255)),
  ADD KEY `IDX_SYS_ENTITY_COMERCIAL_NAME` (`COMERCIAL_NAME`(255));

--
-- Indices de la tabla `sys_entity_branch`
--
...
--
-- Indices de la tabla `sys_entity_param`
--
ALTER TABLE `sys_entity_param`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_SYS_ENTITY_PARAM` (`ENTITY_ID`,`PARAM_ID`),
  ADD KEY `ENTITY_ID` (`ENTITY_ID`),
  ADD KEY `PARAM_ID` (`PARAM_ID`);

--
-- Indices de la tabla `sys_entity_type`
--
ALTER TABLE `sys_entity_type`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `uk_sys_entity_type_code` (`CODE`),
  ADD UNIQUE KEY `uk_sys_entity_type_name` (`GROUP_CODE`,`NAME`);

--
-- Indices de la tabla `sys_entity_user`
--
ALTER TABLE `sys_entity_user`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_ENTITY_USER` (`USER_ID`,`ENTITY_ID`,`ROL_ID`),
  ADD KEY `IDX_ENTITY_USER` (`USER_ID`,`ENTITY_ID`),
  ADD KEY `ENTITY_ID` (`ENTITY_ID`),
  ADD KEY `USER_ID` (`USER_ID`),
  ADD KEY `ROL_ID` (`ROL_ID`);

--
-- Indices de la tabla `sys_image`
--
...
--
-- Indices de la tabla `sys_location`
--
...
ALTER TABLE `sys_module`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_MODULE_NAME` (`NAME`),
  ADD UNIQUE KEY `NAME` (`NAME`),
  ADD UNIQUE KEY `URI` (`URI`),
  ADD UNIQUE KEY `NAME_2` (`NAME`);

--
-- Indices de la tabla `sys_param`
--
...
--
-- Indices de la tabla `sys_password`
--
ALTER TABLE `sys_password`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `USER_ID` (`USER_ID`),
  ADD KEY `PASSWORD_REQUEST_ID` (`PASSWORD_REQUEST_ID`),
  ADD KEY `ind_password_start_date` (`START_DATE`);

--
-- Indices de la tabla `sys_password_request`
--
...
--
-- Indices de la tabla `sys_person`
--
ALTER TABLE `sys_person`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_USER_ID` (`USER_ID`),
  ADD UNIQUE KEY `UK_PERSON_EMAIL` (`EMAIL`,`ID_NUMBER`),
  ADD UNIQUE KEY `UK_PERSON_NAMES` (`FIRST_NAME`,`LAST_NAME`,`ID_NUMBER`),
  ADD KEY `IDX_SYS_PERSON_ID_NUMBER` (`ID_NUMBER`),
  ADD KEY `IDX_SYS_PERSON_EMAIL` (`EMAIL`);

--
-- Indices de la tabla `sys_rol`
--
ALTER TABLE `sys_rol`
  ADD PRIMARY KEY (`ID`),
...
--
-- Indices de la tabla `sys_rol_x_uri`
--
ALTER TABLE `sys_rol_x_uri`
  ADD PRIMARY KEY (`ROL_ID`,`URI_ID`),
  ADD KEY `ROL_ID` (`ROL_ID`),
  ADD KEY `URI_ID` (`URI_ID`);

--
-- Indices de la tabla `sys_uri`
--
ALTER TABLE `sys_uri`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_URI` (`URI`,`MODULE_ID`),
...
--
-- Indices de la tabla `sys_user_param`
--
ALTER TABLE `sys_user_param`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UK_SYS_USER_PARAM` (`USER_ID`,`PARAM_ID`),
  ADD KEY `USER_ID` (`USER_ID`),
  ADD KEY `PARAM_ID` (`PARAM_ID`);

--
-- Indices de la tabla `sys_user_x_rol`
--
...
--
-- Indices de la tabla `tmp_area`
--
ALTER TABLE `tmp_area`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tmp_formacion`
--
ALTER TABLE `tmp_formacion`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tmp_mailing`
--
ALTER TABLE `tmp_mailing`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tmp_prospecto`
--
ALTER TABLE `tmp_prospecto`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `job_area`
--
ALTER TABLE `job_area`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `job_area_habilidad`
--
ALTER TABLE `job_area_habilidad`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `job_area_tecnica`
--
ALTER TABLE `job_area_tecnica`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `job_aviso`
--
ALTER TABLE `job_aviso`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
--
-- AUTO_INCREMENT de la tabla `job_curriculum`
--
ALTER TABLE `job_curriculum`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `job_formacion_academica`
--
ALTER TABLE `job_formacion_academica`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `job_oficio`
--
ALTER TABLE `job_oficio`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `job_profesion`
--
ALTER TABLE `job_profesion`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `job_tipo_formacion`
--
ALTER TABLE `job_tipo_formacion`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `scrap_actividad`
--
ALTER TABLE `scrap_actividad`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `scrap_empresa`
--
ALTER TABLE `scrap_empresa`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `scrap_pagina`
--
ALTER TABLE `scrap_pagina`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `scrap_tipo_empresa`
--
ALTER TABLE `scrap_tipo_empresa`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `sys_email`
--
ALTER TABLE `sys_email`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `sys_email_sent`
--
ALTER TABLE `sys_email_sent`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `sys_entity`
--
ALTER TABLE `sys_entity`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `sys_entity_branch`
--
ALTER TABLE `sys_entity_branch`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `sys_entity_param`
--
ALTER TABLE `sys_entity_param`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `sys_entity_type`
--
ALTER TABLE `sys_entity_type`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `sys_entity_user`
--
ALTER TABLE `sys_entity_user`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `sys_image`
--
ALTER TABLE `sys_image`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `sys_location`
--
ALTER TABLE `sys_location`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT de la tabla `sys_param`
--
ALTER TABLE `sys_param`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `sys_password`
--
ALTER TABLE `sys_password`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `sys_password_request`
--
ALTER TABLE `sys_password_request`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `sys_person`
--
ALTER TABLE `sys_person`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `sys_rol`
--
ALTER TABLE `sys_rol`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `sys_uri`
--
ALTER TABLE `sys_uri`
...
ALTER TABLE `sys_user`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `sys_user_param`
--
ALTER TABLE `sys_user_param`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tmp_mailing`
--
ALTER TABLE `tmp_mailing`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34585;
--
